...
/**
 * Show an packet not assigned for review to this board member.
 */
class InformationalPacket extends ControllerBase {
  ...
  public function display(int $packet_id) {
    ...
    // Use the same theme as we use for a completed packet.
    $options = ['query' => ['referer' => 'ebms_review.fyi_packet']];
    return [
      '#cache' => ['max-age' => 0],
